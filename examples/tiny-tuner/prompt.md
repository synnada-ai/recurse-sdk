...
patch-attention design. A useful starting region is widths (8,16), two convolutions per stage,
batch normalization, ReLU/max pooling, a 3x3 spatial head, Adam learning rate 0.003, weight decay
0.0001, cosine schedule ending at 10%, batch size 128, and ten epochs. That recipe has 5,698
